...
Nearly all cells in animals, plants, and fungi maintain a "default" electrical state called the **Resting Potential**. In most animal cells, **sodium-potassium pumps** in the cell membrane push 3 sodium ions (Na+) out of the cell and 2 potassium ions (K+) into the cell for the cost of one molecule of [Adenosine Tri-phosphate (ATP)](https://en.wikipedia.org/wiki/Adenosine_triphosphate). Ions don't like to be around too many of their own kind, so this creates a sort of “electrical pressure” as the ions try to spread out. This makes Na+ ions eager to enter the cell and K+ ions eager to leave the cell. Other ions are also eager to cross the cell membrane, because the action of the Na+/K+ pumps makes the inside of the cell more negative than the outside (between [40 to 80 millivolts more](https://en.wikipedia.org/wiki/Resting_potential#Summary_of_resting_potential_values_in_different_types_of_cells), to be exact). 

Electrically excitable cells (i.e. neural, glial, muscle, and gland cells) can generate a **Graded Potential** whenever certain chemicals interact with the cell membrane. During graded potentials, ions typically enter or leave the cell via **[ligand-gated ion channels](https://en.wikipedia.org/wiki/Ligand-gated_ion_channel)** (sometimes called "ionotropic receptors"), which are holes in the membrane that open when a chemical attaches itself to the hole (kind of like a lock and key - the chemical is the "key" that "unlocks" the hole in the membrane). Chemicals that let potassium (K+) ions exit the cell tends to make the inside of the cell more negative, and chemicals that let sodium (Na+) or calcium (Ca2+) ions enter the cell tend to make the inside of the cell more positive. Chemicals that let chloride (Cl-) ions enter the cell tend to push the electrical potential of the cell back towards the resting potential. Even very small chemical signals can trigger graded potentials, which vary in size and duration depending on exactly how many ion channels are opened and for how long the channels remain open. Graded potentials are used most often by neurons in sensory organs (["receptor potentials"](https://en.wikipedia.org/wiki/Receptor_potential)) and by neurons that make very short distance connections within regions of the brain. Some organisms, like the worm species *Caenorhabditis elegans*, use **only** graded potentials. 

Other organisms, including some plants, evolved to use a third type of electrical potential, which we call the **Action Potential**, a.k.a. a "**nerve impulse**", "**spike**", or "**when a neuron fires**". When ligand-gated ion channels let in enough Na+ and Ca2+ to make the inside of the cell **much more positive** than the resting potential (at least 15 to 25 millivolts more positive, to be exact), this opens **[voltage-gated](https://en.wikipedia.org/wiki/Voltage-gated_ion_channel) [sodium](https://en.wikipedia.org/wiki/Sodium_channel#Voltage-gated) and [potassium ion channels](https://en.wikipedia.org/wiki/Voltage-gated_potassium_channel)**, holes in the membrane that are sensitive to the voltage across the cell membrane. As Na+ rushes into the cell and makes the inside of the cell more positive, the rapidly rising voltage opens more and more Na+ channels, allowing even more Na+ to enter the cell. The inside of the cell very quickly becomes 40 to 60 millivolts more positive than the outside of the cell, and at this point, the Na+ channels begin to plug themselves shut, such that no more Na+ can enter the cell. However, the K+ channels are still open and letting K+ out of the cell, so the inside of the cell starts to become less and less positive. With no more Na+ entering the cell, and thanks to Ca2+ opening even more K+ channels, the cell's electrical potential quickly drops, briefly becoming even more negative than the resting potential before stabilizing back at 40 to 80 millivolts more negative on the inside than on the outside. This rapid and enormous movement of ions across the membrane can trigger voltage-gated ion channels in nearby parts of the cell membrane to also open up, triggering a traveling wave of action potentials across a long section of membrane. However, neurons don't "pass" electrical signals directly to each other - this is called a "gap junction", which most neurons do **not** use. Instead, neurons use action potentials to quickly trigger the release of chemicals at a synapse, especially when the synapse is relatively very far from the neuron's body. In combination with myelin sheaths, action potentials are thus essential for **long distance** communication in the nervous system, to connect regions of the brain to each other or peripheral neural circuits to the brain.
