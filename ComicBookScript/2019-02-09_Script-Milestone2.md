...
Nearly all cells in animals, plants, and fungi maintain an electrical state called the **Resting Potential**, where the **inside of the cell is more negative than the outside** (between [40 to 80 millivolts more](https://en.wikipedia.org/wiki/Resting_potential#Summary_of_resting_potential_values_in_different_types_of_cells), to be exact). Nervous system cells maintain their resting potential by using [**sodium-potassium pumps**](https://en.wikipedia.org/wiki/Na%2B/K%2B-ATPase) in the cell membrane to push **3 sodium ions (Na+) out** of the cell and **2 potassium ions (K+) in** to the cell for the cost of **1 molecule of [Adenosine Tri-phosphate (ATP)](https://en.wikipedia.org/wiki/Adenosine_triphosphate)**. Ions don't like to be around too many of their own kind, so the Na+/K+ pumps create a sort of “electrical pressure” as the ions try to spread out.  

Electrically excitable cells (i.e. neural, glial, muscle, and gland cells) can generate **Graded Potentials** whenever certain chemicals interact with the cell membrane. During graded potentials, ions typically enter or leave a specific part of the cell via **[ligand-gated ion channels](https://en.wikipedia.org/wiki/Ligand-gated_ion_channel)** (sometimes called "ionotropic receptors"), which are holes in the membrane that open when a chemical attaches itself to the hole (kind of like a lock and key - the chemical is the "key" that "unlocks" the hole in the membrane). Even very small amounts of chemicals can trigger graded potentials, which make the inside of the cell **slightly (between 1 to 15 millivolts) more positive or negative** depending on exactly how many and what kind of ion channels are opened. Graded potentials can also last for varying durations, based on how long the chemicals keep the channels open. These different kinds of graded potentials make the cell **start, stop, or change the release of chemicals** by the cell. Graded potentials are used most often by neurons in sensory organs ("receptor potentials") and by neurons that make very short distance connections within regions of the brain. Some organisms, like the worm species Caenorhabditis elegans, use **only** graded potentials.

Other organisms, including some plants, evolved to use a third type of electrical potential, called an **Action Potential**, "nerve impulse", "spike", or "when a neuron fires". When a part of the cell membrane experiences a large flow of ions that makes the inside of the cell **very positively charged (at least 15 to 25 millivolts more positive than the resting potential)**, voltage-gated ion channels (holes in the membrane that open based on the local electrical potential) open to let a rapid rush of Na+ **into the cell (”influx”)**, then a rapid rush of K+ **out of the cell (”efflux”)**. This rapid and enormous movement of ions across one spot in the membrane also opens voltage-gated ion channels in nearby areas, **triggering a traveling wave of action potentials** across a long section of membrane. When combined with [**myelin sheaths**](https://en.wikipedia.org/wiki/Myelin), action potentials allow cells to **communicate quickly over long distances** (i.e. between regions of the brain or between peripheral neural circuits and the brain). However, unlike graded potentials, action potentials are [**"all-or-none"**](https://en.wikipedia.org/wiki/All-or-none_law), meaning that once the cell's electrical potential is positive enough to open the voltage-gated sodium channels (a moment often called **"reaching the [threshold potential](https://en.wikipedia.org/wiki/Threshold_potential)"**), action potentials will always happen in more or less the same way, regardless of variations in the chemical signal that triggered them.

Both graded and action potentials can trigger **synaptic activity**. When triggered, [**voltage-gated calcium channels**](https://en.wikipedia.org/wiki/Voltage-gated_calcium_channel) in the pre-synaptic membrane open and let a ton of calcium ions (Ca2+) into the cell. The increased Ca2+ levels activate **tiny bags containing neurotransmitters**, called [**vesicles**](https://en.wikipedia.org/wiki/Synaptic_vesicle), which transfer their chemical insides to the next cell in one of two ways. The vesicles can [**fuse to the pre-synaptic membrane and release chemicals into the synaptic cleft ("exocytosis")**](https://en.wikipedia.org/wiki/Exocytosis). The chemicals then bind to the post-synaptic membrane, triggering many different actions by the post-synaptic cell. Afterwards, the pre-synaptic membrane can [**collect the chemicals back into a vesicle ("endocytosis")**](https://en.wikipedia.org/wiki/Endocytosis); or, glial cells called [**astrocytes**](https://en.wikipedia.org/wiki/Astrocyte) can collect chemicals from the synaptic cleft and break them down into nutrients that can be fed back to the neuron. Alternatively, the vesicles can **travel across the synaptic cleft, fuse to the post-synaptic membrane, and release their chemicals directly inside the next cell**. 
