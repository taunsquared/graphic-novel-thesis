...
## Diagram 7: Closing the Loop Between Studying the Nervous System and Living with One
...
Every living human has a nervous system, and uses it everyday. We use our nervous systems when we walk, talk, digest our food, make facial expressions, decide what to wear, and weave our way through traffic. We use our nervous systems when we pick out gifts for lovers, convince children to eat their vegetables or parents to pay for a luxury, debate a philosophical point with friends (or enemies!), and convince the bus driver to give us a free ride "just this once, pretty please!" We use our nervous systems when we plan our finances, operate machines, interpret the law, and negotiate conflict. 

In short, we seem to use our nervous systems for everything we need or want to do every day. And because people are often eager to get what they need or want, all living humans have a pretty good idea of how to use their nervous systems to navigate not only the physical landscape, but also the social landscape of human society. This means that all living humans are, to some degree, "unwitting neuroscientists", who develop a keen sense of both how their nervous system affects their own behaviour and how to use their nervous system to predict others' behaviour. 

I think this is why everyone is fascinated by neuroscience, the study of nervous systems. While it's true that professional neuroscientists have exclusive access to many tools and techniques that can describe nervous systems in extraordinary detail or measure them with painstaking precision, when professional neuroscientists *use* these tools and techniques, or *interpret* the measurements they get, they are still using something that *everyone* has: a nervous system. 

Everyone has a lifetime of intimate, personal experience with nervous systems. This makes neuroscience rather unlike many other topics of formal study, such as marine biology or particle physics. Not everyone has access to the ocean, and when's the last time you had an intimate, personal experience with the [Higgs boson](https://en.wikipedia.org/wiki/Higgs_boson)?

This isn't to say that neuroscience is easy. The study of nervous systems by definition requires nervous systems, presenting professional neuroscientists with a bit of a circular dilemma: can you understand the very thing that is your greatest tool for understanding anything? (We could also discuss what it means to "understand" something, but we'll have to save that discussion for another graphic novel.) Also, in the last 60 years since neuroscience first became a distinct discipline of formal study, many people have tackled what they thought was a relatively straightforward question or puzzle in neuroscience, only to realize that a decade has passed and they are still full of more questions than answers. 

As an optimist, I'm willing to assume that understanding nervous systems, especially my own personal nervous system, is possible. So how can we get better at studying nervous systems? I like the idea that "two heads are better than one" when it comes to solving really tricky problems, and a [recent study](https://www.scientificamerican.com/article/are-two-heads-better-than/) offers some evidence that this catchy idiom might be true. The key, according to this study, is good communication and an accurate awareness of one's strengths and weaknesses. 

Let's apply that result to professional neuroscience. One of the field's greatest strengths is the very detailed descriptions and highly precise measurements made possible by laboratory neuroscience methods. However, one of the greatest weaknesses of current professional neuroscience is that our most powerful laboratory methods are most often used on isolated pieces of nervous systems (and most often used on non-human animals, adding an extra step of translation between species), and are very difficult to use on whole, intact nervous systems in their most natural and healthy states. 

Luckily, not only have other research disciplines (such as ethology, anthropology, psychology, physiology, and sociology) have developed methods of describing and measuring whole and healthy nervous systems, so if neuroscientists can communicate well with researchers in these other fields, we can complement each others' strengths and weaknesses! In addition, the enormous wealth of insight from the "unwitting neurosciestist" within every person is currently largely untapped. If the professional neuroscience research community can communicate well with everyday people about how they use their nervous systems in their lives, we can further complement the strengths and weaknesses of both professional neuroscientists and *everyone else*. So how might we develop these relationships? 

For a start, it will be hugely helpful if we could develop ways of conducting rigorous and replicable research *outside* the traditional neuroscience laboratory. Why? Very few people are allowed inside traditional neuroscience laboratories, and so it's hard to involve researchers from other fields and the population of "unwitting neuroscientists" in traditional laboratory neuroscience research. And spaces where everyone is invited to participate in building and organizing knowledge already exist, such as museums, public libraries, zoos, and aquariums! With just a few tweaks, these spaces can easily host high-quality neuroscience research, and become places where professional, unwitting, and aspiring neuroscientists can collaborate. 
