...
A [**chemical synapse**](https://en.wikipedia.org/wiki/Chemical_synapse) is formed when the membranes of two cells come **very close** to each other without actually touching. At this "biological junction", neurons can very precisely exchange chemicals called **neurotransmitters** with each other and with other non-neuronal cells (glial, muscle, or gland cells). A synapse includes a pre-synaptic membrane, a synaptic cleft (the tiny gap between the membranes), a post-synaptic membrane, and the [surrounding glia](https://en.wikipedia.org/wiki/Tripartite_synapse). Any change in the chemical content of the **extracellular ("outside the cell") space** surrounding nervous system cells can trigger electrical activity. 
...
Nearly all cells in animals, plants, and fungi maintain a "default" electrical state called the **Resting Potential**. In most animal cells, **sodium-potassium pumps** in the cell membrane push 3 sodium ions (Na+) out of the cell and 2 potassium ions (K+) into the cell for the cost of one molecule of [Adenosine Tri-phosphate (ATP)](https://en.wikipedia.org/wiki/Adenosine_triphosphate). Ions don't like to be around too many of their own kind, so this creates a sort of “electrical pressure” as the ions try to spread out. At the resting potential, Na+ ions really want to enter the cell and K+ ions really want to leave the cell. Other ions are also eager to cross the cell membrane, because the action of the Na+/K+ pumps makes the inside of the cell more negative than the outside (between [40 to 80 millivolts more](https://en.wikipedia.org/wiki/Resting_potential#Summary_of_resting_potential_values_in_different_types_of_cells), to be exact). 

Electrically excitable cells (i.e. neural, glial, muscle, and gland cells) can generate a **Graded Potential** whenever certain chemicals interact with the cell membrane. During graded potentials, ions typically enter or leave the cell via **[ligand-gated ion channels](https://en.wikipedia.org/wiki/Ligand-gated_ion_channel)** (sometimes called "ionotropic receptors"), which are holes in the membrane that open when a chemical attaches itself to the hole (kind of like a lock and key - the chemical is the "key" that "unlocks" the hole in the membrane). Chemicals that let potassium (K+) ions exit the cell tends to make the inside of the cell more negative, and chemicals that let sodium (Na+) or calcium (Ca2+) ions enter the cell tend to make the inside of the cell more positive. Chemicals that let chloride (Cl-) ions enter the cell tend to push the electrical potential of the cell back towards the resting potential. Even very amounts of chemicals can trigger graded potentials, which vary in size and duration depending on exactly how many and what kind of ion channels are opened and for how long the channels remain open. In turn, the different kinds of graded potentials can either trigger the release of chemicals or change the amount of chemicals released by the cell. Graded potentials are used most often by neurons in sensory organs (["receptor potentials"](https://en.wikipedia.org/wiki/Receptor_potential)) and by neurons that make very short distance connections within regions of the brain. Some organisms, like the worm species *Caenorhabditis elegans*, use **only** graded potentials. 

Other organisms, including some plants, evolved to use a third type of electrical potential, called an **[Action Potential](https://en.wikipedia.org/wiki/Action_potential)**, "**nerve impulse**", "**spike**", or "**when a neuron fires**". When ligand-gated ion channels let in enough Na+ and Ca2+ to make the inside of the cell **much more positive** ([at least 15 to 25 millivolts more positive, to be exact](https://en.wikipedia.org/wiki/Threshold_potential)) than the resting potential, this opens **[voltage-gated](https://en.wikipedia.org/wiki/Voltage-gated_ion_channel) [sodium](https://en.wikipedia.org/wiki/Sodium_channel#Voltage-gated) and [potassium ion channels](https://en.wikipedia.org/wiki/Voltage-gated_potassium_channel)**, holes in the membrane that are sensitive to the voltage across the cell membrane. As Na+ rushes into the cell and makes the inside of the cell more positive, more and more Na+ channels open and allow even more Na+ to enter the cell. The inside of the cell very quickly becomes 40 to 60 millivolts more positive than the outside of the cell, and at this point, the Na+ channels begin to plug themselves shut, such that no more Na+ can enter the cell. However, the K+ channels are still open and letting K+ out of the cell. With no more Na+ entering the cell, the cell's electrical potential quickly drops, briefly becoming even more negative than the resting potential before stabilizing back at the resting potential (at this point, the voltage-gated sodium channels unplug themselves). This rapid and enormous movement of ions across the membrane can open voltage-gated ion channels in nearby parts of the cell membrane, triggering a traveling wave of action potentials across a long section of membrane. When combined with the insulating power of myelin sheaths, action potentials allow cells to **communicate quickly over long distances** (i.e. between regions of the brain or between peripheral neural circuits and the brain). However, unlike graded potentials, action potentials are **"all-or-none"**, meaning that once the cell's electrical potential is positive enough to open the voltage-gated sodium channels (a moment often called "reaching the threshold potential"), action potentials will always happen in more or less the same way, regardless of any variations in the chemical signal that triggered them. 

Both graded and action potentials can lead to **synaptic activity**. When the pre-synaptic membrane experiences a strong enough electrical potential, **voltage-dependent calcium channels** open up in the pre-synaptic membrane and let a ton of calcium (Ca2+) ions rush into the cell. The increased Ca2+ levels activate tiny bags containing neurotransmitters, called **vesicles**, which transfer the neurotransmitters to the next cell in one of two ways. The vesicles can fuse to the pre-synaptic membrane and release neurotransmitters into the synaptic cleft; the neurotransmitters then bind to the post-synaptic membrane, triggering many different actions by the post-synaptic cell. Alternatively, these vesicles can travel across the synaptic cleft, fuse to the post-synaptic membrane, and release the neurotransmitters directly inside the next cell. Once neurotransmitter has been released into the synaptic cleft, the pre-synaptic membrane can collect the neurotransmitters back into a vesicle. Glial cells called **astrocytes** can also collect neurotransmitters from the synaptic cleft and break them down into nutrients that can be fed back to the neuron. 
